...
def createDirectory():
    ...
    #try:
        ...
        directory_creation = file_service.create_directory(share_name=share_name,directory_name=clusterid/clusterid,metadata=None,fail_on_exist=True,timeout=None)
