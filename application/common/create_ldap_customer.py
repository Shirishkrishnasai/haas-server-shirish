...
def azureldapcustomer(customer_id,display_name,customer_gid_id,user_principal_name,mail_nickname,password):
    ...
    try:
        ...
        dn_user = "cn="+str(mail_nickname)+",cn="+str(display_name)+",ou=" + customer_id + ",dc=kwartile,dc=local"
        userlist = {
    ...
    # addModList transforms your dictionary into a list that is conform to ldap input.
        ...
        user_insertion=TblUsers(uid_customer_id=customer_id,var_user_name=display_name,txt_dn=dn_user,bool_active='t')
