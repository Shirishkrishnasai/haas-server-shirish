...
def bigsizefiledownload(uploadid):
    ...
    my_logger.info(account_name, account_key)
    ...
    while startrange <= 55000:
        ...
        file_service.get_file_to_bytes(share_name=file_values[0], directory_name=file_values[1],
                                       file_name=file_values[2], start_range=startrange, end_range=endrange,
