...
def requestresponse(request_id):
    try:
        ...
        customer_job_request_query=session.query(TblCustomerJobRequest.var_diagnostics,TblCustomerJobRequest.var_request_status,TblCustomerJobRequest.var_application_id).filter(TblCustomerJobRequest.uid_request_id==request_id)
