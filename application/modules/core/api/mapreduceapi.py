...
def map_r(request_id):
    ...
    customer_job_request_query=session.query(TblCustomerJobRequest.var_job_name,TblCustomerJobRequest.var_job_description).filter(TblCustomerJobRequest.uid_request_id==request_id)
