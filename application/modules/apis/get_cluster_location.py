...
from application.models.models import TblMetaCloudLocation, TblMetaCloudType
...
def clusterLocation():
    ...
    meta_cluster_location_query = session.query(TblMetaCloudLocation.var_cloud_type,TblMetaCloudLocation.var_location).all()
    dict_location={}
    list_location = []
