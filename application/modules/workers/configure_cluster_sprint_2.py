...
def configure_cluster(request_id):
	...
	cluster_id = 'ae945516-09bc-11e9-b4fe-000c29da5704'
        ...
        print "in"
	print "11111111111111111111111111111",feature_id,"noooooooooooooooooo",cluster_id

        print "generating task type info dict for task generation"
	...
	print "444444444444444444444444444444444444",task_types_info_dict
        ...
        vm_roles_query=session.query(TblVmCreation.uid_cluster_id,TblVmCreation.uid_agent_id,TblVmCreation.var_role,TblVmCreation.var_ip,TblVmCreation.uid_vm_id).filter(TblVmCreation.uid_customer_id == customer_id,TblVmCreation.uid_cluster_id == cluster_id,TblVmCreation.bool_edge == 'f').all()
