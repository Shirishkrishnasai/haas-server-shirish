...
class TblAddressTypes(db.Model):
...
class TblKafkaTopicPurposeType(db.Model):
...
class TblServerSideVersion(db.Model):
...
class TblServerWorkersMapping(db.Model):
...
class TblCustomerAzureResourceGroup(db.Model):
...
class TblKafkaConsumerGroup(db.Model):
...
class TblCustomerRequest(db.Model):
...
class TblVirtualNetwork(db.Model):
...
class TblKafkaPublisher(db.Model):
...
class TblVmInformation(db.Model):
...
class TblNodeInformation(db.Model):
...
class TblAgentTopicTable(db.Model):
...
class TblAzureAppGateway(db.Model):
...
class TblMetaNodeRoles(db.Model):
...
class TblUsers(db.Model,OutputMixin):
...
class TblMetaTaskStatus(db.Model):
...
class TblTaskStatusLog(db.Model):
...
class TblMetaRequestStatus(db.Model):
...
class TblTaskRequestLog(db.Model):
