from application.models.models import TblFeature,TblTaskType,\
    ...
    TblMetaFileUpload, TblHiveMetaStatus, TblMetaCloudLocation, TblEdgenode, TblClusterType,TblCluster,TblAzureAppGateway, TblVmCreation,TblCustomer
...
tbl_app_gateway=TblAzureAppGateway(srl_id = 1,
...
tbl_customer=TblCustomer(srl_id =1,
    uid_customer_id = Uid_customer_id,
    uid_gateway_id = 'aa182744-0aa7-11e9-ba4c-3ca9f49ab2cc',
    ...
    ts_created_datetime = None,
    ts_modified_datetime = None)
